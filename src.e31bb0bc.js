...
var btnStartEl = document.querySelector('[data-action = start]');
var btnStopEl = document.querySelector('[data-action = stop]');
btnStartEl.addEventListener('click', onClick);
btnStopEl.addEventListener('click', onClick);

var changeBodyBackground = function changeBodyBackground() {
...
function onClick() {
  if (this.getAttribute('data-action') === 'start') {
    var interId = setInterval(changeBodyBackground, 300, 300);
    intervalId = interId;
